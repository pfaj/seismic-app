  ...
  return (
    <>
      ...
      <section className="slideshowPopup hidden" id="slideshowPopup">
        <div id="disclaimer">Turn Device to view images.</div>
        <div className="container" id="slideshowImages">
          <a className="close" onClick={() => SlideShowView.closeSlideshow()}>
            &#10005;
          </a>
          <a className="next" onClick={() => SlideShowView.plusSlides(1)}>
            &#10095;
          </a>
          <a className="prev" onClick={() => SlideShowView.plusSlides(-1)}>
            &#10094;
          </a>
        </div>
